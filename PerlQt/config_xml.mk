...
# this line will be scaned by script/gen_makefile_pl.pl
# no make variables inside, keep value in one line
XML_DEFINES  := -DQT_XML_LIB -DQT_SHARED -DQT_NO_DEBUG
...
EXTRA_DEFINES := -DQT_NO_KEYWORDS -DQ_DECL_EXPORT="Q_DECL_EXPORT" -DQ_XML_EXPORT="Q_DECL_EXPORT"

ALL_DEFINES   := $(XML_DEFINES) $(EXTRA_DEFINES)
...
# no make variables inside, keep value in one line
LDFLAGS := -L/usr/lib/qt4 -lQtXml -lQtCore
