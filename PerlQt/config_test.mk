...
# this line will be scaned by script/gen_makefile_pl.pl
# no make variables inside, keep value in one line
TEST_DEFINES  := -DQT_TEST_LIB -DQT_SHARED -DQT_NO_DEBUG
...
EXTRA_DEFINES := -DQT_NO_KEYWORDS -DQ_DECL_EXPORT="Q_DECL_EXPORT" -DQ_TESTLIB_EXPORT="Q_DECL_EXPORT"

ALL_DEFINES   := $(TEST_DEFINES) $(EXTRA_DEFINES)
