...
# this line will be scaned by script/gen_makefile_pl.pl
# no make variables inside, keep value in one line
MULTIMEDIA_DEFINES  := -DQT_MULTIMEDIA_LIB -DQT_SHARED -DQT_NO_DEBUG -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtMultimedia -I/usr/include/qt4
...
EXTRA_DEFINES := -DQT_NO_KEYWORDS -DQ_DECL_EXPORT="Q_DECL_EXPORT" -DQ_MULTIMEDIA_EXPORT="Q_DECL_EXPORT"

ALL_DEFINES   := $(MULTIMEDIA_DEFINES) $(EXTRA_DEFINES)
...
# no make variables inside, keep value in one line
LDFLAGS := -L/usr/lib/qt4 -lQtMultimedia -lQtGui -lQtCore
